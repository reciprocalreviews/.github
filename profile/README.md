...
* [PaperStack](https://www.paperstack.pub/) offers a holistic reinvention of publishing models, with a similar token system, but also a reviewing model separate from publishing workflows.
